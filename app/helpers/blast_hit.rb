...
require_relative 'blast_graphic'
  ...
  def annotation_href link_name, with_anchor
    ...
    elsif @hit_name.start_with?("s6_")
      href = "/blast_dbs/fastasearch?file=symb6master.fa&query=#{@hit_name}&commit=Search"
    elsif @hit_name.start_with?("s4_")
      href = "/blast_dbs/fastasearch?file=symb4master.fa&query=#{@hit_name}&commit=Search"
