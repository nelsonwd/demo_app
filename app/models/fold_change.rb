...
#8 - fdr
  ...
  while(line = file.gets)
    ...
    FoldChange.create(:log2fc => parts[6], :fdr => parts[8], :pval => parts[7], :de_analysis_id => de_analysis_id, :treatment_id => treatment_id, :base_treatment_id => base_treatment_id, :sequence_id => seq.id) 
  end
end
end
