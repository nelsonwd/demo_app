...
describe "auto1h_fold_changes/new.html.erb" do
  before(:each) do
    assign(:auto1h_fold_change, stub_model(Auto1hFoldChange,
      :log2fc => 1.5,
      :fdr => 1.5,
      :pval => 1.5,
      :de_analysis_id => 1,
  ...
  it "renders new auto1h_fold_change form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => auto1h_fold_changes_path, :method => "post" do
