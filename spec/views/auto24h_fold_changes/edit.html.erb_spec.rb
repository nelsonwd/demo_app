...
describe "auto24h_fold_changes/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit auto24h_fold_change form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => auto24h_fold_changes_path(@auto24h_fold_change), :method => "post" do
