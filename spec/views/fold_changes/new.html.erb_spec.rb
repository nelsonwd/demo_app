...
describe "fold_changes/new.html.erb" do
  before(:each) do
    assign(:fold_change, stub_model(FoldChange,
      :log2fc => 1.5,
      :fdr => 1.5,
      :pval => 1.5,
      :de_analysis_id => 1,
  ...
  it "renders new fold_change form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => fold_changes_path, :method => "post" do
